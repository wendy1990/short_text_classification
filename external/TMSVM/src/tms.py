...
def tms_train_model(problem_path,svm_type="libsvm",param="", model_save_path="../svm.model"):
    ...
    train_model.ctm_train_model(problem_path, svm_type, param, model_save_path)
    
def tms_predict_(model_file_name,data_file_name,result_save_path,param):
    ...
    '''
    predict_model.predict_rsl(model_file_name,data_file_name,result_save_path,param)
...
def tms_analysis(filename,output_file="",indexes=[0,1,2],step=2,predicted_label_index=0,predicted_value_index=1,true_label_index=2,threshold=0.0,label=1,min=0,max=1):
